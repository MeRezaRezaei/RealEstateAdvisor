...
<div class="container-fluid float-right text-right" style="padding: 0px;margin: 0px;border: 0px">
    <form onsubmit="return Validator()">
        <div class="col row" style="padding: 7px;margin: 0px;border: 0px">

            <div class="col" style="border:5px solid #636b6f;padding: 5px;margin: 0px;font-size: 30px">
                <div class="col badge-secondary text-right Options " style="font-size: 50px">لطفا نوع ملک را انتخاب
                    کنید
                </div>
                <select class=" custom-select custom-select-lg text-right"
                        style="font-size: 60px;text-align: right;border:5px solid #636b6f;padding: 0px;padding-right: 20px;margin-top: 5px;margin-bottom: 5px"
            ...
            <div class="col-12" style="padding: 0px;margin: 0px;border: 0px" id="PropertyForm">
            ...
            <div class="col-12" style="padding: 0px;margin: 0px;border: 0px" id="DealSelection">
            ...
            <div class="col-12" style="padding: 0px;margin: 0px;border: 0px" id="DealForm">

            </div>
            {{-- you can use check values whit this button --}}
            <div class="col-12" style="padding: 0px;margin: 0px;border: 0px" id="">
            ...
            <div class="col-12" style="padding: 0px;margin: 0px;border: 0px" id="Validate">
...
<script>
    ...
    function DealBuilder(DealTypeName) {
        ...
        var Deal = " " +
            "<div class='col' style='border:3px solid #636b6f;padding: 5px;margin: 0px;' id=''>" +
            "<div class='col badge-secondary text-right Options' style='font-size: 50px'>لطفا نوع معامله را انتخاب کنید</div>" +
            "<select class=' custom-select custom-select-lg text-right' style='font-size: 60px' id='DealType' onchange='DealFormBuilder()'>" +
            options+
            "</select>" +
            "</div>";
    ...
    function AddressBuilder(label, id) {
        ...
        var Html = "" +
            "<div class=\"col-12\" style=\"border:5px solid #636b6f;padding: 5px;margin: 0px;font-size: 30px\" id='" + id + "Border'>\n" +
            "<div class=\"col12 badge-secondary text-right Options \" style=\"font-size: 50px\" id='" + id + "Label'>" + label + "</div>\n" +
            "<textarea maxlength='200' placeholder='توضیحات خود را وارد کنید'  class=\" custom-select custom-select-lg text-right\" style=\"font-size: 60px;text-align: right;border:5px solid #636b6f;padding: 0px;padding-right: 20px;margin-top: 5px;margin-bottom: 5px;width: 100%;height: 400px\" id=\"" +
            id +
            "Input\" onblur=\"AddressValidate('" + id + "')\"  onchange=\"AddressValidate('" + id + "')\">\n" +
            "</textarea>\n" +
            "<div class='col-12 badge-secondary text-right Options' style='font-size: 50px' id='" + id + "Error'>هنوز تغییر ایجاد نشده</div>" +
            "</div>" +
            "<div class=\"col-12\" id=\"\">\n" +
            "<p></p>\n" +
            "</div>" +
    ...
    function DescriptionBuilder(label, id) {
        var Html = "" +
            "<div class=\"col-12\" style=\"border:5px solid #636b6f;padding: 5px;margin: 0px;font-size: 30px;\" id='" + id + "Border'>\n" +
            "<div class=\"col-12 badge-secondary text-right Options \" style=\"font-size: 50px\" id='" + id + "Label'>" + label + "</div>\n" +
            "<textarea  maxlength='200' placeholder='توضیحات خود را وارد کنید'  class=\" custom-select custom-select-lg text-right\" style=\"font-size: 60px;text-align: right;border:5px solid #636b6f;padding: 0px;padding-right: 20px;margin-top: 5px;margin-bottom: 5px;width: 100%;height: 400px\" id=\"" +
            id +
            "Input\" onblur=\"DescriptionValidate('" + id + "')\"  onchange=\"DescriptionValidate('" + id + "')\">\n" +
            "</textarea>\n" +
            "<div class='col-12 badge-secondary text-right Options' style='font-size: 50px' id='" + id + "Error'>در صورت نیاز توضیحات را وارد کنید</div>" +
            "</div>" +
            "<div class=\"col-12\" id=\"\">\n" +
            "<p></p>\n" +
            "</div>" +
    ...
    function NumberBuilder(label, min, max, id) {
        ...
        var Html = "" +
            "<div class='col-12 Border' id='" + id + "Border'>" +
            "<div class='col-12 badge-secondary text-right Options Label' id='" + id + "Label'  >" + label + "</div>" +
            "<input class=\"form-control form-control-lg text-right Input\"  type=\"text\" placeholder=" +
            "\"" +
            "لطفا عدد بین " +
            min +
            " تا " +
            ...
            "<div class='col badge-secondary text-right Options Error'  id='" + id + "Error'>هنوز تغییر ایجاد نشده</div>" +
            "</div>" +
            "</div>" +
            "</div>" +
            "<div class=\"col-12\" id=\"\">\n" +
    ...
    function OptionBuilder(label, options, id) {
        ...
        var Html = "" +
            "<div class=\"col Border\"  id='" + id + "Border'>\n" +
            "<div class=\"col badge-secondary text-right Options Label\"  id='" + id + "Label'>" + label + "</div>\n" +
            "<select name='Options' class=\" custom-select custom-select-lg text-right Input\"  id=\"" +
            id +
             ...
             if(Deal != 'NOT'){
                 ...
                 for(var i in Property){
                     ...
                     Html += "" +
                         ...
                         "<p></p>\n" +
                         "</div>" +
                         "<a href='#"+Property[i]['id']+"Border'>"+
                         "<div class='col-12 Border' id=''>" +
                         "<div class='col badge-"+Color+" text-right Options Error'   id=''>"+Label+"</div>" +
                         "<div class='col badge-"+Color+" text-right Options Error'   id=''>"+Input+"</div>" +
                         "</div>" +
                         "</div>" +
                         "</a>";
                 }
